...
<?php  if (!isset($_POST['submit']))  {
            ...
            if($fileToUpload!='') {
                ...
                if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                    $sql = "INSERT INTO key_practices (`title`,`year`,`description`, `image`, `status`) VALUES ('$title', '$year','$description','$fileToUpload','$status')";
                    ...
                    <div class="row">
                        <form class="col s12" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="input-field col s12">
                                    <input id="year" autofocus="autofocus" type="text" class="validate" name="year" required>
