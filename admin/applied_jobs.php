                                ...
                                <table id="example" class="display responsive-table datatable-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo $base_url . 'uploads/resumes/'.$row['resume'] ?>"><img src="<?php echo $base_url.'img/200word.png'?>" height="35px" width="35px" title="<?php echo $row['resume'];?>"></a></td>
                                        </tr>               
                                        <?php $i++; } ?>
                                    </tbody>
                                </table>
